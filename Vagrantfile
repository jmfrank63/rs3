...
#   config.vm.network "forwarded_port", guest: 80, host: 8080, host_ip: "127.0.0.1"
  config.vm.network "forwarded_port", guest: 80, guest_ip: "192.168.5.100", host: 6000, host_ip: "127.0.0.1"
  config.vm.network "forwarded_port", guest: 8080, guest_ip: "192.168.5.100", host: 6001, host_ip: "127.0.0.1"
